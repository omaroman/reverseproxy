...
ReverseProxy switches between HTTP and HTTPS schemes by using a frontend *Reverse-Proxy* server application,
e.g., Nginx, Apache, Lighttpd.

h2. Requirements

* A Reverse-Proxy server configured
* For SSL, the *certificate* and its *key*
...
Author: Omar O. Román and Omar García
