...
An Action from another Action shall NOT be INVOKED like a regular Java call, i.e., Controller.action(),
...
Do NOT use the *Secure* module bundled with Play, Instead use SecureController and SecureInterceptor and implement your own
...
This module has been tested with Play built-in server as standalone in conjunction with Nginx, Apache and Lighttp.

h2. JEE App Container

I tested the module with Jetty-1.6.24 and, unfortunately, throws an exception...
