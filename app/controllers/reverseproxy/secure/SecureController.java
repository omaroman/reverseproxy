...
//            login();  // <--- DO NOT Invoke this way
            ...
            // or
            render("@login"); // renders views/SecureController/login.html
        }
        // Mark user as connected
        session.put("username", username);
        // Remember if needed
        if(remember) {
            CookieUtility.writeCookie(COOKIE_NAME, Crypto.sign(username) + "-" + username, "30d");
        }
    ...
    public static void logout() throws Throwable {
        ...
        session.clear();
        CookieUtility.removeCookie("rememberme");
